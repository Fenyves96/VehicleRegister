...
public class VehicleRegister implements VehicleWriter, VehicleReader {
    VehicleValidator vehicleValidator = new VehicleValidator();
    VehicleParser vehicleParser = new VehicleParser();
    VehicleRepository vehicleRepository;
    VehiclePresenter vehiclePresenter;

    public VehicleRegister(VehicleRepository vehicleRepository, VehiclePresenter presenter) {
